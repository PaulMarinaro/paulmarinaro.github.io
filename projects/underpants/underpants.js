...
*   2) return a new array of elements for which calling <function> returned 
*   true
* Gotchas:
...
_.unique = function(array) {
    ...
    // loop through array
    _.each(array, function(element, index, array){
        // if index is not in not in newArray
...
_.every = function(collection, func) {
    ...
    // reject, if array is > 0, then return false
    var rejected = _.reject(collection, func);
...
_.some = function(collection, func) {
    ...
    // if collection length is = rejected array length, then return false
    if (rejected.length === collection.length) {
        return false;
    }   else {
        return true;
    }
...
_.extend = function(object1, ...object2) {
    ...
    // 1) Copy properties from <object 2> to <object 1>
    _.each(object2, function(element, index, array) {
        for (var key in element) {
        object1[key] = element[key];
        }
    })
