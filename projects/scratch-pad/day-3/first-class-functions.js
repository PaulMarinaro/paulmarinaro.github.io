 ...
 * return a Function 
 *      that tests whether a given value is greater than the 
 * base.
 */
function createGreaterThanFilter(base) {
    // YOUR CODE BELOW HERE //
    function myInnerFunction(value) {
        return value > base;
    }
...
function createStartsWithFilter(startsWith) {
    ...
    return function(string) {
        return startsWith.toLowerCase() === string.charAt(0).toLowerCase(); 
    }
 ...
 * 
 * TIP: You need to loop over the Strings, right? We need to 
 * pass each String to the modify Function, 
 * but we need to collect the results into some collection.
 */
 ...
 * and a Function designed to test the String in some 
