...
var arraysCombined = [];
console.log(arrays.reduce((a, b) => arraysCombined.concat(a, b)));
...
And finally, it calls the update function to create a new value, 
...
which have a script associated with them. The characterScript and 
countBy functions defined earlier in the chapter are probably useful here.
*/

function dominantDirection(text) {
  var counted = countBy(text, char => {
